...
enum {
	DESC_MATCHER_UNSPEC = 0,
	DESC_MATCHER_4B,
	DESC_MATCHER_8B,
	/* max 2 bits */
	__DESC_MATCHER_SIZE = 0x3,
};

enum desc_proto_type {
	DESC_PROTO_UNSPEC	= 0,
};

enum desc_proto_l2 {
	DESC_PROTO_ETH = DESC_PROTO_UNSPEC + 1,
};

enum desc_proto_l3 {
	DESC_PROTO_IPV4 = DESC_PROTO_ETH + 1,
	DESC_PROTO_IPV6,
};
...
struct hdr_cursor {
	...
	int mhoff;
	enum desc_proto_l2 mhtype; 

	int nhoff;
	enum desc_proto_l3 nhtype;
